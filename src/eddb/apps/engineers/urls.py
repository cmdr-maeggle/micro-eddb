...
from eddb.apps.engineers.views import BlueprintListView
...
urlpatterns = [
    url(r"engineers^$", ListView.as_view(model=Engineer), name="engineer_list"),
    url(r"engineers/(?P<pk>\d+)$", DetailView.as_view(model=Engineer), name="engineer_detail"),
